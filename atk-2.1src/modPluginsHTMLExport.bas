...
Private Function CreateHTMLTableRow(ByVal RowName As String, ByVal VariantContent As String, Optional ByVal LinkURL As String)
...
Public Sub ExportPluginsToHTMLFile()
    ...
    'Write log entry
    WriteLogEntry "Exporting loaded plugins list to html file ..."
    ...
    HTMLListContent = "<html>" & vbCrLf & _
        ...
        "<p>Software: <a href=http://www.computec.ch/projekte/atk/ target=_TOP>" & SoftwareName & "</a>" & vbCrLf & _
    ...
    For i = 0 To LoadedPlugins
        ...
        HTMLListContent = HTMLListContent & _
        "<tr align=left valign=top>" & vbCrLf & _
        "<td align=left valign=top><font face=Verdana><font size=-1><a href=""" & plugin_filename & ".html" & """>" & plugin_name & " " & plugin_version & "</a></font></font></td>" & vbCrLf & _
        ...
        HTMLPluginContent = HTMLPluginContent & _
            ...
            CreateHTMLTableRow("Plugin created email", plugin_created_email, _
                ...
                "[1] http://www.computec.ch/projekte/atk/") & _
        ...
        HTMLPluginContent = HTMLPluginContent & _
            ...
            CreateHTMLTableRow("Plugin request", plugin_request) & _
            CreateHTMLTableRow("Plugin trigger", plugin_trigger) & _
        ...
        HTMLPluginContent = HTMLPluginContent & _
            ...
            CreateHTMLTableRow("Bug published email", bug_published_email, "mailto:" & bug_published_name & " <" & bug_published_email & ">?subject=" & plugin_name & "&" & _
                ...
                "[2] http://www.computec.ch/projekte/atk/") & _
            ...
            CreateHTMLTableRow("Bug vulnerability class", bug_vulnerability_class)
        ...
        HTMLPluginContent = HTMLPluginContent & _
            ...
            CreateHTMLTableRow("Source Misc.", source_misc, "http://www.google.ch/search?q=" & source_misc)
