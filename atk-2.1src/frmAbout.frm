...
Begin VB.Form frmAbout 
   ...
   Begin VB.Frame fraAboutInfo 
      ...
      Begin VB.Label lblCopyrights 
         Caption         =   "The Attack Tool Kit (ATK) is developed and maintained (2003-2004) by"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.Frame fraFrame 
      ...
      Begin VB.Frame fraMerchandising 
         ...
         Begin VB.Image imgShirt 
            Height          =   2115
            Left            =   720
            MouseIcon       =   "frmAbout.frx":2C92
            MousePointer    =   99  'Custom
            Picture         =   "frmAbout.frx":2F9C
...
Private Sub Form_Load()
    Me.Caption = SoftwareName & " About"
    WriteLogEntry frmAbout.Caption & " opened."
    ...
    Call AddTeamMember("Anner, Martin", "martin_anner@swissonline.ch", "http://www.computec.ch/projekte/atk/", "ATK Alien Logo Painting")
    ...
    Call AddTeamMember("Spicher, Nico", "triplex@it-helpnet.de", "http://www.it-helpnet.de", "Beta Testing")
...
Private Sub Form_Unload(Cancel As Integer)
    WriteLogEntry frmAbout.Caption & " closed."
...
Private Sub lblEmail_Click()
    ...
    WriteLogEntry "Writing an email to " & DestinationEMail
    Call ShellExecute(hwnd, "Open", "mailto:" & DestinationEMail & "?subject=" & SoftwareName, "", "", 1)
End Sub
...
Private Sub lblProjectWebsite_Click()
    ...
    WriteLogEntry "Loading the project website " & WebSiteURL
...
Private Sub lblShirtAdvertisement_Click()
    ...
    strShirtShopURL = "http://www.computec.ch/projekte/atk/shop/frames.html"

    'Load the shirt shop
    WriteLogEntry "Loading the shirt shop " & strShirtShopURL
...
Private Sub lsvTeam_ColumnClick(ByVal ColumnHeader As MSComctlLib.ColumnHeader)
    WriteLogEntry "Reorder the selected ATK project team entries."
    lsvTeam.Sorted = True
    
    If lsvTeam.SortKey = ColumnHeader.Index - 1 Then
        If lsvTeam.SortOrder = lvwAscending Then
            lsvTeam.SortKey = ColumnHeader.Index - 1
            lsvTeam.SortOrder = lvwDescending
        Else
            lsvTeam.SortKey = ColumnHeader.Index - 1
            lsvTeam.SortOrder = lvwAscending
        End If
    Else
        lsvTeam.SortKey = ColumnHeader.Index - 1
        lsvTeam.SortOrder = lvwAscending
...
Private Sub lsvTeam_DblClick()
    ...
    If lsvTeam.ListItems.Count <> 0 Then
        ...
        'Load the project web site
        WriteLogEntry "Loading the ATK project team member website " & WebSiteURL
        Call ShellExecute(Me.hwnd, "Open", WebSiteURL, "", App.Path, 1)
    End If
End Sub
...
Private Function AddTeamMember(ByVal strName As String, ByVal strEmail As String, _
    ByVal strWebsite As String, ByVal strFunction As String)
