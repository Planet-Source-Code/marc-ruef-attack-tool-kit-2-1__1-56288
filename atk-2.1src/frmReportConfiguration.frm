...
'    cmbReportTemplates.AddItem "ISS Internet Scanner report"
    ...
    lstVulnerabilityPositions.AddItem "plugin_request"
    lstVulnerabilityPositions.AddItem "plugin_trigger"
...
Private Sub lstHeaderPositions_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    If Button = 1 Then
        ...
        DY = TextHeight("A")
        lblDragAndDrop.Move fraHeaderCustomizing.Left + lstHeaderPositions.Left, fraHeaderCustomizing.Top + lstHeaderPositions.Top + Y - DY / 2, lstHeaderPositions.Width, DY
        lblDragAndDrop.Drag
...
Private Sub lstVulnerabilityPositions_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    If Button = 1 Then
        ...
        lblDragAndDrop.Move fraVulnerabilitiesCustomizing.Left + lstVulnerabilityPositions.Left, _
            fraVulnerabilitiesCustomizing.Top + lstVulnerabilityPositions.Top + Y - DY / 2, lstVulnerabilityPositions.Width, DY
        lblDragAndDrop.Drag
...
Private Sub Form_Unload(Cancel As Integer)
    WriteLogEntry "Unloading the " & Me.Caption & " window."
